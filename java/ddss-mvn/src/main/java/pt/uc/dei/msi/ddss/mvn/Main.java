...
public class Main {
    ...
    private static final String JDBC_PSQL_CONN_LOCAL = "jdbc:postgresql://localhost:5432/ss-db-a1";
    private static final String JDBC_PSQL_CONN_DOCKER = "jdbc:postgresql://db:5432/ss-db-a1";
    private static final String JDBC_USER = "ss-db-a1";
    private static final String JDBC_PASS = "ss-db-a1";
